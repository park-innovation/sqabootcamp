...
//List<Map<String, String>> data=dataTable.asMaps();
    ...
    public void personal_details_form_should_display(io.cucumber.datatable.DataTable dataTable) {
        Map<String, List<String>>table=dataTable.asMap(String.class ,List.class);
        //List<Map<String, String>> data = dataTable.asMaps();
        Assert.assertEquals(table.get("first name").get(1), personalDetailsObject.getFirstNameTest());
        Assert.assertEquals(table.get("last name").get(1), personalDetailsObject.getLastNameTest());
