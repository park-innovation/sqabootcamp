...
public class AttachmentTest
{
 ...
 //Add Attachment without comment
    ...
    {
        Assert.assertTrue("user is not on MyInfo menu item",menuItemScreenObject.employeeImageDisplayed());
    }
    ...
    {
        Assert.assertTrue(string+"is not displayed in the attachments table",attachmentsObject.checkFileName(string));
    }
//Add Attachment with comment
    ...
    {
        Assert.assertTrue(string+ " is not displayed for attachment "+string2,attachmentsObject.checkComment_FileName(string2,string));
    }
